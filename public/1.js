...
var update = __webpack_require__(202)("355c06d5", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(77);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 3;
                                return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/api/menus');
        ...
        hasSub: function hasSub(menu) {
            if ('sub_menu' in menu && menu.sub_menu.length > 0) {
                return true;
            }
            return false;
        },
        selectHandler: function selectHandler(index, path) {
            var reg = /^\d.*$/;
            var breadcrumb = [];
                  ...
                  _vm._l(_vm.menus, function(menu) {
                    return [
                      _vm.hasSub(menu)
                        ...
                        : [
                            _c("el-menu-item", { attrs: { index: menu.url } }, [
